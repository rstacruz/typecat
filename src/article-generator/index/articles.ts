const simpleSentences = [
  ...
  'Nearly every composer wrote for the violin, whether as a solo instrument, in chamber music, in orchestral music, folk music, and even in jazz.',
  ...
  'Each station was decorated with tiled motifs on seating recesses to differentiate them from each other.',
  ...
  "Oxygen makes up more than a fifth of the Earth's atmosphere by volume.",
  ...
  'The common allotrope of oxygen on Earth is called dioxygen.',
  "This is the second biggest part of the Earth's atmosphere, after dinitrogen.",
  ...
  'There are small amounts of carbon dioxide in the air, and it is turned into carbohydrates during photosynthesis.',
  'Many organic solvents also have oxygen, such as acetone, methanol, and isopropanol.',
  'Oxygen is also found in nearly all biomolecules that are made by living things.',
